...
public class BauxiteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("transit_add_on:bauxite_ore", FEATURE,
				new OreConfiguration(BauxiteOreFeatureRuleTest.INSTANCE, TransitAddOnModBlocks.BAUXITE_ORE.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("transit_add_on:bauxite_ore", CONFIGURED_FEATURE,
	...
	private static class BauxiteOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("transit_add_on:bauxite_ore_match"), CUSTOM_MATCH);
		}
