...
public class SteelOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("transit_add_on:steel_ore", FEATURE,
				new OreConfiguration(SteelOreFeatureRuleTest.INSTANCE, TransitAddOnModBlocks.STEEL_ORE.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("transit_add_on:steel_ore", CONFIGURED_FEATURE,
	...
	private static class SteelOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("transit_add_on:steel_ore_match"), CUSTOM_MATCH);
		}
